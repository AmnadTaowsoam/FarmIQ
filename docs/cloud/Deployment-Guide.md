...
เครื่องมือนี้ถูกออกแบบมาเพื่อช่วย deploy FarmIQ Cloud Layer ได้ทั้งในสภาพแวดล้อม development และ production เพื่อให้การทำงานสะดวกและมีประสิทธิภาพ
...
- **OS**: Windows 10+, macOS 10.15+, หรือ Ubuntu 20.04+
- **RAM**: 8GB+ (แนะนำ 16GB)
- **Storage**: 20GB+ free space
- **CPU**: 4 cores+ (แนะนำ 8 cores)

#### Production Environment
- **OS**: Ubuntu 20.04+ LTS (แนะนำ)
- **RAM**: 32GB+ (แนะนำ 64GB)
- **Storage**: 100GB+ SSD
- **CPU**: 8 cores+ (แนะนำ 16 cores)
...
- **Redis**: 7.0+
- **Apache Kafka**: 3.5+
- **Nginx**: 1.24+ (เช่น ใช้งานใน production)
...
### Network Security
- ใช้ firewall เพื่อกำหนดขอบเขตการเข้าถึง
- ใช้ VPN สำหรับการเข้าถึงจากภายนอกองค์กร
- ใช้ TLS/SSL สำหรับการเข้ารหัสข้อมูล

### Application Security
- ใช้ environment variables สำหรับเก็บ secrets
- ใช้ strong passwords สำหรับ JWT secrets
- เปิดใช้ CORS อย่างเหมาะสมและปลอดภัย
- ใช้ rate limiting

### Database Security
- ใช้ strong database passwords
- กำหนดสิทธิ์การเข้าถึง database
- ใช้ SSL สำหรับ database connections
- เปิดใช้งาน audit logging

---

เริ่มใช้งานสำหรับการเก็บข้อมูลจริง: 2024-01-15
