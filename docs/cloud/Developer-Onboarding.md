...
## การติดตั้งระบบใน FarmIQ Cloud Layer

คุณสามารถติดตั้งและใช้งานส่วนประกอบต่าง ๆ ของ FarmIQ Cloud Layer เพื่อรองรับการเก็บข้อมูลและประมวลผลได้อย่างมีประสิทธิภาพ
...
- **Python**: 3.11+ (สำหรับ Analytics services)
- **Docker**: 20.10+ และ Docker Compose 2.0+
- **Git**: 2.40+ (Version control)
- **VS Code**: (แนะนำ) พร้อมติดตั้ง extensions:
  - TypeScript Importer
  - Prisma
  - Docker
  - REST Client
...
เริ่มใช้งานระบบการเก็บข้อมูลครั้งแรก: 2024-01-15
