...
<<<<<<< HEAD
    ...
    ingestUrl: process.env.CAPTURE_INGEST_URL ?? 'http://localhost:6304/api/ingest/image',
=======
    enabled: bool(process.env.CAPTURE_ENABLED, true),
    mediaDir: resolvePath(process.env.CAPTURE_MEDIA_DIR, 'tmp/mock-capture'),
    ingestUrl: process.env.CAPTURE_INGEST_URL ?? 'http://localhost:6304/api/upload',
>>>>>>> 02db03862a3128c2995be68033a7122ad794d3a0
